...
const SvgQuestionRed = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="none" {...props}>
    <g clipPath="url(#question_red_svg__a)">
      <path
        fill="#FFDDDB"
        fillRule="evenodd"
        d="M12.004 22c5.523 0 10-4.477 10-10s-4.477-10-10-10-10 4.477-10 10 4.477 10 10 10"
        clipRule="evenodd"
      />
      <path
        fill="#F1351C"
        ...
        clipRule="evenodd"
      />
      <rect width={2} height={2} x={11.004} y={15.999} fill="#F1351C" rx={1} />
    </g>
    <defs>
      <clipPath id="question_red_svg__a">
        <path fill="#fff" d="M0 0h24v24H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgQuestionRed;
