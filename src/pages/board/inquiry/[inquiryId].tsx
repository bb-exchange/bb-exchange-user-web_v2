  ...
  return (
    <div id={styles.inquiryDetail}>
      <div className={styles.content}>
        <div>
          {returnBtn()}
          <p className={styles.title}>{D_INQUIRY_LIST?.[Number(query?.inquiryId)]?.title}</p>
        ...
        <p className={styles.description}>
          안정적인 서비스 제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인 서비스 제공을
          위하여 시스템 점검을 실시할 예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을 실시할
          예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인 서비스
          제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을
          실시할 예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인
          서비스 제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인 서비스 제공을 위하여 시스템
          점검을 실시할 예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을 실시할
          예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인 서비스
          제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을
          실시할 예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인
          서비스 제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인 서비스 제공을 위하여 시스템
        ...
        {reply && (
          <>
            ...
            <div className={styles.sectionOfReply}>
              ...
              <p className={styles.description}>
                안정적인 서비스 제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인 서비스 제공을
                위하여 시스템 점검을 실시할 예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을
                실시할 예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을 실시할
                예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인
                서비스 제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인 서비스 제공을 위하여
                시스템 점검을 실시할 예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을 실시할
                예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인
                서비스 제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인 서비스 제공을 위하여
                시스템 점검을 실시할 예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을 실시할
                예정입니다.안정적인 서비스 제공을 위하여 시스템 점검을 실시할 예정입니다.안정적인
