...
const price = 0;
const description =
  "예신 예랑 걱정 끝! 이걸로 결혼준비 끝💸 \n드레스투어꿀팁 부터 웨딩홀할인, 플래너찾는법, 박람회꿀팁, 비용아끼는법, 똑똑하게 결혼하세요~";

export default function Post() {
  const hook = UsePost();
  const replyList: Array<any> = D_latestPostList[7].replyList;
            ...
            <>
              <article className={`${styles.d} ${styles.contArea}`}>
                ...
                <p>
                  ...
                  웨딩홀부터 시작해 일명, &apos;스드메&apos;라고 불리는
                  스튜디오, 드레스, 메이크업 업체를 선정하는 일은 상당히
                  복잡하다. 워낙 많은 업체가 있을 뿐만 아니라, 가격도 천지차이기
                  때문이다. 결혼 준비를 하는 예비신부, 예비신랑을 위해 웨딩홀
                  선정 및 결혼 비용 절약하는 스드메 선정 팁을 소개한다.
                </p>
                ...
                <p>
                  ...
                  때는 업체 3-4곳을 방문상담을 잡은 후, &apos;웨딩홀
                  투어&apos;라는 것을 진행한다. 웨딩플래너가 있다면 웨딩플래너를
                  통해 스케줄을 잡으면 되고, 혼자 진행한다면 웨딩홀에 연락하여
                  일정을 잡으면 된다.
                </p>
                <p>
